...
var _Square2 = _interopRequireDefault(require("./Square.js"));
...
function (_Square) {
  ...
  _createClass(Circle, [{
    key: "draw",
    value: function draw() {
      var element = "\n        <div style=\"width:".concat(this.width, "px;height:").concat(this.width, "px;background:").concat(this.color, ";left:").concat(this.left, "px;top:").concat(this.top, "px;position:absolute;border-radius:50%\"></div>\n        ");
